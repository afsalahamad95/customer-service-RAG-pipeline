        ...
        try:
            ...
            with db_manager.get_session() as session:
                query = text(
                    ...
                    VALUES (:title, :content, CAST(:embedding AS vector), :model, CAST(:metadata AS jsonb))
                    RETURNING id
                """
                )
    ...
    def search(
        ...
        try:
            ...
            with db_manager.get_session() as session:
                ...
                if metadata_filter:
                    base_query += " AND metadata @> CAST(:metadata AS jsonb)"
                ...
                params = {"embedding": str(emb_list), "limit": top_k}
