...
from src.utils.exceptions import DatabaseException, ConnectionException
...
class DatabaseManager:
    ...
    def _initialize(self):
        ...
        try:
            ...
            logger.info(f"Database connection initialized: {self.db_config['host']}:{self.db_config['port']}")
